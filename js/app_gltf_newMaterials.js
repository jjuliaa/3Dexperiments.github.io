...
function loadModels() {
  ...
  const CUPPosition = new THREE.Vector3( 0, 0, 25);
  loader.load( 'models/CUP.glb', gltf => onLoad( gltf, CUPPosition, newStandard), onProgress, onError );

  const Position2 = new THREE.Vector3( 0,0,0 );
  loader.load( 'models/TABlE.glb', gltf => onLoad( gltf, Position2, pointsMaterial), onProgress, onError );
